...
void CD::affichaeInformation(){
  std::cout << "L'auteur est " << this->Auteur << " la maison de production est " << this->MaisonProduction << " le titre est " << this->Titre << " la duree est " << this->duree << " le nombre de piste est " << this->NombrePistes << std::endl;
}